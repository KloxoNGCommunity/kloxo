...
$__information['phpini_updateform_edit_admin_pre'] = "<p>Installing PHP modules (like xcache/ioncube/zend/suhosin) rpm via yum. Installing these modules depend on php branch and version installed on system.</p>" .
	...
	"<p>Ask to <a href='https://www.facebook.com/groups/KloxoNextGeneration' target='_blank'>forum</a> to know how to install php extension for 'multiple php'. Generally, using 'sh /script/phpm-extension-installer'.</p>" .
	"<p>Click <url:o=serverweb&a=show>[here]</url> to install another php for 'Multiple PHP'.</p>" .
	"<p><b>Note:</b></p>" .
	"<ul>" .
		"<li>for enable 'multiple php' need install php55m, php56m, php70m, php71m, php72m, php73m and php74m  with 'sh /script/phpm-installer php54m' (example for php54m)</li>" .
		"<li>for shared-hosting, better install all phpXYm series</li>" .
		"<li>Format for 'multiple php ratio' is 'a:b:c:d' where 'a' for php55m, 'b' for php56m, 'c' for php70m and 'd' for php71m</li>" .
	"</ul>" .
	"</p>" .
