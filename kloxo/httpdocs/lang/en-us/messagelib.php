...
$__information['updateform_forcedeletepserver_pre'] = "Force delete Server just removes the server from Kloxo-MR's database. This is useful if the server has been completely removed is no longer accessible.";
...
$__information['updateform_portconfig_pre'] = "This page is primarily meant to configure the ports of Kloxo-MR. After making the changes here, you will need to restart Kloxo-MR service once for the changes to take effect. Run this command '[b]sh /script/defaultport[/b]' and the ports will be reset to the default. You can then restart Kloxo-MR. Leave the fields blank to revert to default ports. ";
...
$__information['custombutton_addform__pre'] = " In the url, you can use %nname%, which will be substituted with the name of the client. For Kloxo-MR only, you can use %default_domain% for the default domain of the client.";
...
// $__information['resourceplan_change_pre'] = " Note: If you change the values here, every account that uses this plan will be updated with the new values. Click <url:a=updateForm&sa=account&o=resourceplan>here to see the accounts configured on this plan</url>";
$__information['resourceplan_show__pre'] = " Note: If you change the values here, every account that uses this plan will be updated with the new values. Click <url:a=updateForm&sa=description>here to see the accounts configured on this plan</url>";
...
$__information['phpini_updateform_edit_admin_pre'] = "You have to enable the [b] Manage Php Configuration [/b] flag to let Kloxo-MR manage your php.ini completely. Please note that your old php.ini will be overwritten. To restore your old php.ini, just disable [b] Manage Php Configuration [/b] and update. It is recommended that you let Kloxo-MR completely handle your php configuration, and ask in our forum if you need special features.";
...
$__information['server_alias_a_addform__pre'] = "- You can add wildcards (*) as an alias so that all the subdomains are automatically directed to this domain. ".
	"Kloxo-MR will also automatically add a DNS entry for the alias.<br />".
...
$__information['mysqldb_updateform_restore_pre'] = "You can use this only to restore the backups that were explicitly taken in Kloxo-MR itself using the [b] Get Backup [/b] tab. To restore normal mysql dump file, please use phpMyAdmin.";
...
$__information['domain_addform__pre_docroot'] = "Leave the document root blank and Kloxo-MR will automatically use mydomain.com as the docroot.";
...
$__information['vv_dns_template_message'] = "[b]Primary and Secondary DNS[/b] - 'default.dns' is 'symbolic' domain name if selecting 'default' for 'DNS Template Name'. " .
	"[b]Example[/b] - 'ns1.default.dnst' (on 'Primary DNS') will be converted to 'ns1.domain.com' for 'domain.com'";
...
$__information['client_show__pre'] = "No information...";
$__information['domain_show__pre'] = "No information...";
$__information['pserver_show__pre'] = "No information...";
$__information['mailaccount_show__pre'] = "No information...";

$__information['smessage_addform__pre'] = "No information...";

$__information['ticket_addform__pre'] = "No information...";
$__information['helpdeskcategory_a_addform__pre'] = "No information...";

$__information['all_domain_list__pre'] = "No information...";
$__information['all_addondomain_list__pre'] = "No information...";
$__information['all_mailaccount_list__pre'] = "No information...";
$__information['all_mailforward_list__pre'] = "No information...";
$__information['all_mysqldb_list__pre'] = "No information...";
$__information['all_cron_list__pre'] = "No information...";
$__information['all_ftpuser_list__pre'] = "No information...";
$__information['all_mailinglist_list__pre'] = "No information...";

$__information['resourceplan_addform__pre'] = $__information['resourceplan_change_pre'];

$__information['reversedns_addform__pre'] = "Reverse dns only work for Class C (256 ips) or more";
$__information['general_updateform_reversedns_pre'] = "No information...";
$__information['all_dns_list__pre'] = "No information...";
$__information['all_reversedns_list__pre'] = "No information...";

$__information['dnstemplate_addform__pre'] = $__information['vv_dns_template_message'];
$__information['dnstemplate_show__pre'] = "No information...";

$__information['dns_show__pre'] = $__information['vv_dns_ddns_message'];
$__information['dns_updateform_rebuild_pre'] = $__information['vv_dns_rebuild_message'];
$__information['dns_record_a_addform_ns_pre'] = $__information['vv_dns_a_message'];
$__information['dns_record_a_addform_a_pre'] = $__information['vv_dns_ns_message'];
$__information['dns_record_a_addform_cname_pre'] = $__information['vv_dns_cname_message'];
$__information['dns_record_a_addform_fcname_pre'] = $__information['vv_dns_fcname_message'];
$__information['dns_record_a_addform_mx_pre'] = $__information['vv_dns_mx_message'];
$__information['dns_record_a_addform_aaaa_pre'] = $__information['vv_dns_aaaa_message'];
$__information['dns_record_a_addform_txt_pre'] = $__information['vv_dns_txt_message'];
$__information['dns_updateform_parameter_pre'] = $__information['vv_dns_soa_message'];

$__information['dns_record_a_updateform_edit_pre'] = "No information...";

$__information['domain_addform__pre'] = "No information...";
$__information['subdomain_addform__pre'] = "No information...";
$__information['mailaccount_addform__pre'] = "No information...";
$__information['sp_specialplay_updateform_skin_pre'] = "No information...";

$__information['lxupdate_updateform_lxupdateinfo_pre'] = "No information...";
$__information['releasenote_list__pre'] = "No information...";

$__information['client_updateform_password_pre'] = "No information...";

$__information['auxiliary_addform__pre'] = "No information...";
$__information['all_auxiliary_list__pre'] = "No information...";

$__information['lxbackup_show__pre'] = "No information...";
$__information['lxbackup_updateform_restore_from_file_pre'] = "No information...";
$__information['lxbackup_updateform_ftp_conf_pre'] = "No information...";
$__information['lxbackup_updateform_schedule_conf_pre'] = "No information...";

$__information['ffile_updateform_upload_s_pre'] = "No information...";
$__information['ffile_updateform_download_from_http_pre'] = "No information...";
$__information['ffile_updateform_download_from_ftp_pre'] = "No information...";

$__information['ffile_show__pre'] = "No information...";

$__information['domaindefault_updateform_update_pre'] = "No information...";
$__information['utmp_list__pre'] = "No information...";
$__information['ftpsession_list__pre'] = "No information...";
$__information['client_updateform_shell_access_pre'] = "No information...";

$__information['general_updateform_scavengetime_pre'] = "No information...";
$__information['general_updateform_generalsetting_pre'] = "No information...";
$__information['general_updateform_selfbackupconfig_pre'] = "No information...";
$__information['general_updateform_selfbackupconfig_pre'] = "No information...";
$__information['general_updateform_portconfig_pre'] = "No information...";
$__information['general_updateform_maintenance_pre'] = "No information...";

$__information['dirindexlist_a_addform__pre'] = "No information...";
$__information['sp_specialplay_updateform_upload_logo_pre'] = "No information...";
$__information['client_updateform_disable_url_pre'] = "No information...";
$__information['client_updateform_skeleton_pre'] = "No information...";
$__information['notification_show__pre'] = "No information...";
$__information['sp_specialplay_updateform_login_options_pre'] = "No information...";

$__information['client_updateform_miscinfo_pre'] = "No information...";
$__information['sp_childspecialplay_updateform_skin_pre'] = "No information...";

$__information['psrole_a_addform__pre'] = "No information...";

$__information['pserver_updateform_reboot_pre'] = "No information...";
$__information['pserver_updateform_poweroff_pre'] = "No information...";

$__information['service_list__pre'] = "No information...";
$__information['process_list__pre'] = "No information...";
$__information['component_list__pre'] = "No information...";
$__information['llog_show__pre'] = "No information...";
$__information['ffile_updateform_content_pre'] = "No information...";
$__information['driver_updateform_update_pre'] = "No information...";

$__information['pserver_updateform_timezone_pre'] = "No information...";
$__information['pserver_updateform_commandcenter_pre'] = "No information...";
...
$__information['dbadmin_addform__pre'] = "No information...";
$__information['pserver_updateform_mysqlpasswordreset_pre'] = "No information...";

$__information['sslcert_list__pre'] = "No information...";
$__information['sslcert_addform__pre'] = $__information['sslcert_updateform_update_pre'];
$__information['sslcert_addform_uploadfile_pre'] = "No information...";
$__information['sslcert_addform_uploadtxt_pre'] = "No information...";
...
$__information['servermail_updateform_update_pre'] = "No information...";
$__information['servermail_updateform_spamdyke_pre'] = "No information...";
$__information['mail_graylist_wlist_a_addform__pre'] = "No information...";

$__information['client_list__pre'] = "No information...";
$__information['all_client_list__pre'] = "No information...";
$__information['client_addform_wholesale_pre'] = "No information...";
