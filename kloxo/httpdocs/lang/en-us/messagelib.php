...
$__emessage['phpini_not_set'] = "Need update php.ini to make sure the website able to process php files. Click <url:o=phpini&a=show>[here]</url> to set it. The same way for 'slave' server";
