...
$gl_class_array['anonftpipaddress__pureftp'] =  "driver/pserver/anonftpipaddress__pureftplib.php";
...
//--// $gl_class_array['servermail__mailenable'] =  "driver/pserver/servermail__mailenablelib.php";
...
$gl_class_array['ftpuser__pureftp'] = "driver/pserver/ftpuser__pureftplib.php";
$gl_class_array['ftpusertraffic__pureftp'] = "driver/pserver/ftpusertraffic__pureftplib.php";
//--// $gl_class_array['ftpuser__iisftp'] = "driver/pserver/ftpuser__iisftplib.php";
$gl_class_array['ftpsession__pureftp'] = "driver/pserver/ftpsession__pureftplib.php";
