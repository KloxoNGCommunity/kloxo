...
?>
											<table cellpadding="0" cellspacing="0" border="0" height="27">
												...
												<tr>
													...
													<td nowrap valign=middle background="<?php echo $imgheadbg; ?>">
														<b><font color="#ffffff"><?php echo get_plural($classdesc[2]) ?>
																under <?php echo $parent->display("nname") ?>
														</b> <?php echo $this->print_machine($parent) ?> <b>
															(<?php echo $total_num ?>)</b></font></td>
										...
										<td colspan=3>
											<table cellpadding=0 cellspacing=0 border=0 width=100% height=35
												...
												<tr>
													...
													<td width=15% align=right><b><font
																color="#ffffff"><?php $this->print_search($parent, $class); ?></font></b>
													</td>
												</tr>
											</table>
										</td>
											...
											<table cellpadding=0 cellspacing=0 border=0 width=100%>
												<tr>
													<td width=100% height=2
													    background="<?php echo $imgtopline; ?>"></td>
												</tr>
											</table>
										</td>
										<td align=right>
											<table cellpadding=0 cellspacing=0 border=0 width=100%>
												<tr>
													<td><img src="<?php echo $imgheadleft; ?>"></td>
													<td nowrap width=100% background="<?php echo $imgheadbg; ?>">
														<b><font color="#ffffff"> Confirm <?php echo $descr[1] ?>:
														</b><?php echo get_plural($classdesc[2]) ?>
...
?>
						<td <?php echo $wrapstr; ?> width="<?php echo $width; ?>"><table cellpadding=0 cellspacing=0 border=0> <tr> <td <?php echo $wrapstr; ?> rowspan=2>
<?php
					} else {
						$wrapstr .= " background=$imgtablerowhead";
?>
						<td width="<?php echo $width; ?>" <?php echo $wrapstr; ?> class=col>
<?php
					}
...
?>
					...
					<td width=15><img src="<?php echo $imgarrow; ?>"></td>
					<td></td></tr></table>
<?php
...
?>
				<td width=10 background=<?php echo $imgtablerowhead ?>>
					<form name="formselectall<?php echo $unique_name; ?>" value=hello><input 
						type=checkbox name="selectall<?php echo $unique_name; ?>" value=on <?php if ($sellist) echo "checked disabled"; ?> onclick="javascript:calljselectall<?php echo $unique_name; ?> ()">
					</form>
				</td>
			</tr>
<?php
...
?>
				...
				<tr id=tr<?php echo $unique_name . $rowcount; ?> class=tablerow<?php echo $count; ?>
...
?>
					<td width=10>
						<a class=button href="javascript:callSetSelectFolder('/$ret/$basename')"> Select </a>
				</tr>
<?php
...
?>
							<table width=95%>
								<tr align=center>
									<td width=100%><b> No <?php echo get_plural($classdesc[2]) ?>
											under <?php echo $parent->nname ?>   </b></td>
								</tr>
							</table>
<?php
						}
...
?>
			...
			<tr>
				...
				<td colspan="<?php echo $nlcount; ?>">
					<table cellpadding=0 cellspacing=0 border=0 width=100%>
						<tr height=1 style='background:url(<?php echo $imgtopline; ?>)'>
							<td></td>
						</tr>
						<tr>
							<td>
