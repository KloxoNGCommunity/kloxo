					...
					<table cellpadding=0 cellspacing=0 border=1>
						<tr>
							<td>
								...
								<table cellpadding="2" cellspacing="7" border="0" height="100%" width="100%">
									<tr align=left>
										<td align=left>
<?php
		$n = 1;
...
?>
				...
				<legend style='font-weight:normal'><b><span
							style='color:#303030; font-weight:normal'><?= $u ?></span></b></legend>
				<table cellspacing=7 width="100%" border=0> <tr align=left> <td align=left>
<?php
				continue;
			}
...
?>
		...
		<table cellpadding="4" cellspacing="4">
			<tr>
				<td>
					>>>> <a href="javascript:toggleVisibility('listaddform_<?= $unique_name ?>');"> Click Here to
...
<?php
	...
	function print_include_jscript($header = null)
	{
		...
		$this->print_jscript_source("/panel/js/lxa.js");
		$this->print_jscript_source("/panel/js/helptext.js");
		$this->print_jscript_source("/panel/js/preop.js");
		...
		$this->print_css_source("/panel/css/ext-all.css");
...
?>
			...
			<script language=Javascript src=/panel/js/divpop.js></script>
...
<?php
				...
				include("panel/fckeditor/fckeditor_php5.php");


				$oFCKeditor = new FCKeditor($variable->name);
				$oFCKeditor->BasePath = '/panel/fckeditor/';
...
<?php
	...
	function tab_vheight()
	{
		...
		$this->print_css_source("/panel/css/examples.css");
		print_ext_tree($login);

?>

		<script type='text/javascript' src='/panel/js/tabs-example.js'></script>
...
?>
		...
		<script language="javascript" type="text/javascript" src="/panel/js/xpmenu/ua.js"></script>
		<script language="javascript" type="text/javascript" src="/panel/js/xpmenu/PanelBarOrig.js"></script>
...
?>
			...
			<link href="/panel/js/tree/dtree.css" rel="stylesheet" type="text/css"/>
<?php
			$ghtml->print_jscript_source("/panel/js/tree/dtree.js");
			$scriptdone = true;
		}
