...
UPDATE `watchdog` SET `nname`='php-fpm___localhost',`parent_clname`='pserver-localhost',`parent_cmlist`='',`servicename`='php-fpm',`syncserver`='localhost',`port`='/etc/init.d/php-fpm status',`action`='__driver_php-fpm',`status`='on',`added_by_system`='on',`oldsyncserver`='',`olddeleteflag`='' WHERE `nname`='php-fpm___localhost';
