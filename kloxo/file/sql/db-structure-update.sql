...
('pop3___localhost', 'pserver-localhost', '', 'pop3', 'localhost', '110', '/etc/init.d/dovecot restart', 'on', 'on', '', ''),
('imap4___localhost', 'pserver-localhost', '', 'imap4', 'localhost', '143', '/etc/init.d/dovecot restart', 'on', 'on', '', ''),
